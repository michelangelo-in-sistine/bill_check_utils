...
bill_category_keywords = (
    {
        'food': ['肯德基', '老盛昌', '全家', '水果', '汉堡王', '必胜客', '红宝石', '多乐之日',
                 ...
                 '1973继光香香鸡悦达88', '沃歌斯', '阿拉本帮', '翠园', '博多一幸舍#拉面#', 'Sunflour#面包#', '哈氏食品', '百果园', '西贝莜面村', '武圣羊汤', '百年卤煮', '蘑范儿小鸡炖蘑菇', '三人行骨头王' 
                 ],
