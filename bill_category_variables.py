...
bill_category_keywords = (
    {
        'food': ['肯德基', '老盛昌', '全家', '水果', '汉堡王', '必胜客', '红宝石', '多乐之日',
                 ...
                 '多乐房', '不二原麦#面包#', '剁椒鱼头', '梅龙镇快餐', '麦吉#奶茶#', '麻辣烫', '好利来', '薯语', '南门涮肉', '湘蒸味#东方万国食堂#',
        ...
        'life': ['绿地优鲜超市', '华住', '宝岛眼镜', '上蔬永辉', '迪亚天天', '窝的鲜花', '茶阁里的猫',
                 ...
                 '万物心选', '快递', '永辉超市', 'KKV#印象城杂货铺#', '第五季发型', '完美日记#化妆品#', 'X11#印象城杂货铺#', '多特瑞#精油#', 
                 ],

        'coffee & tea': ['星巴克', '花神咖啡馆', '歌帝梵#冰淇淋#', '上海喜创于茶', '壹加花园', '百兰谷咖啡', 'NO+COFFEE', '乐乐茶', '玛格琳尼#巧克力#', 
                         '西舍咖啡', 'Manner Coffee', '1+Garden', 
                         ],
                       
        'dressing': ['优衣库', 'HM', '盖璞', '热风', 'GU', '服装', '飒拉', '新天泽雅柔', '海澜之家', '弥淑服饰', '永兴东润中国服饰', 
                     '茉莉屋#内衣贴身#', 'nikoand#衣服#', '三黄时装'],

        'taxi': ['嘀嗒', '美团 && amount < 20', '滴滴出行', '曹操出行', '申城出行#打车#', ],

        'traffic': [ '上海交通卡',  '钧正网络#哈罗单车#', '地铁APP', '杭州青奇',  '通驰科技#上海地铁#', '广州骑安#青桔单车#'],

        'car': ['石油化工', '十院停车场', '速泊车生活', '上海绿地东汽车销售', '停简单#小布跳舞的家乐福停车#', '停车', '上海宝山天街', '迈泊停车', 
                '高速通行费', '上海声珩建筑装潢服务#爱康国宾体检中心停车#', '申隆石化双城站', 
                ],
        
        'shopping': ['京东', '久光', '芮欧', 'JD', '开市客#Cosco#', '沃尔玛'],
        
        'basic': ['城投水务', '电力公司', '手机充值', '上海燃气有限公司', '保利叶语物业', '中国电信股份有限公司', '保利物业'],
        
        'entertain': ['幸福蓝海', '格瓦拉', '主题乐园', '顾村公园', '野生动物园', '迪士尼', '中影#电影#', ],
        
        'medicine': ['复旦大学附属华山医院', '药房', '儿童医院', '第十人民医院', '望族国宾', '挂号网', '华山北院', '叮当快药',
                    ],
