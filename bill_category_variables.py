...
bill_category_keywords = (
    {
        ...
        'life': ['绿地优鲜超市', '华住', '宝岛眼镜', '上蔬永辉', '迪亚天天', '窝的鲜花', '茶阁里的猫',
                 ...
                 '快团团#顾村生活群#', '九木杂物社', 'OCE#杂货店#', 'AlexshopStore#进口食品小超市#'
                 ],
        ...
        'dressing': ['优衣库', 'HM', '盖璞', '热风', 'GU', '服装', '飒拉', '新天泽雅柔', '海澜之家', '弥淑服饰', '永兴东润中国服饰', 
                     '茉莉屋#内衣贴身#', 'nikoand#衣服#', '三黄时装', '女装9', '上海乐橙贸易商行#龙之梦衣饰#'
                 ],
        ...
        'shopping': ['京东', '久光', '芮欧', 'JD', '开市客#Cosco#', 'Outland#户外用品#'],
        ...
        'raise child': ['网易考拉', '卡通尼', '麦淘亲子', '亲子',
                        ...
                        'mideer弥鹿母婴旗舰店#玩具#', 'FIZZ+IN+BLUE#童装#', '斯凯奇贸易#童鞋#'
                        ],
