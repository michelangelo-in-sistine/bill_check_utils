...
bill_category_keywords = (
    {
        'food': ['肯德基', '老盛昌', '全家', '水果', '汉堡王', '必胜客', '红宝石', '多乐之日',
                 ...
                 '老乡鸡', '稻花情', '同记粥铺', '川湘人家', '大唐渔夫人', '隆江猪脚饭', '大厨作煮',
                 '敦煌小吃', '大米先生', '贵州羊肉粉', '老灶脚猪脚饭', '云膳过桥米线', '浦明面馆',
                 '椿山日料店', '杀猪粉', '西域传奇', '落汤鱼', '农耕记#天安云谷#', '阿一猪扒#天安云谷#',
                 '湘食小馆#国展绿地#', '老郑家东北春饼#天安云谷#', 'TacoBell', '玺炖',
                 '故乡妈妈', '煲仔皇', '港式烧腊饭', '小满手工粉', '辣潮纪拌粉',
                 '衢州鸭头', '米村拌饭', '老太太拌饭', '莱香盖码饭', '胡子大厨', '手作鲜意面',
                 '韩式炸鸡', '腊味煲仔饭', '牛之粿', '陕西面馆', '大斌烧烤', '赛百味', 
                 '芸山季', '不入川豆花馆', '李连贵熏肉', '啫啫煲', '你捞我烫砂锅', '深圳木屋烧烤', 
                 'SloppyGin#延平路面包店#', '遇见小面', '仟仟陶鲜鸡火锅', '顾村海鲜大排档', '锅贴', '辣富友', '鲜肉饼', '眉州东坡', '汤伯府', 
                 '阳澄湖莲花岛林其饭店#大闸蟹#', 'Nutsfun#龙湖披萨西餐#', 'Mbay贝湾',
                 ],
        ...
        'life': ['京东', '绿地优鲜超市', '华住', '宝岛眼镜', '上蔬永辉', '迪亚天天', '窝的鲜花', 
                 ...
                 '顺丰同城','金多乐商贸#淘宝猫粮#', '一扫光', '便利店', '甄果鲜园', '青浦西岑时新超市', 
                 ],
        ...
        'coffee & tea': ['星巴克', '花神咖啡馆', '歌帝梵#冰淇淋#', '上海喜创于茶', '壹加花园', 
                 ...
                 '阿拉比卡咖啡','NewWorldcafe#坂田咖啡厅#', '与伱酸奶#小布芭蕾楼下酸奶#',
                 '天使之橙', 'DQ', 'Tims Coffee', '挞柠', '小红花办事处', '猫空咖啡MOKO', 'ReefCoffee礁石#象山海边咖啡店#', 
                ],
        ...
        'holiday': ['去哪儿网', '酒店', '海昌极地海洋', '海昌公园', '恐龙园文化旅游集团'],
